...
public class StudentCRUDTest extends TestBase {
    ...
    static String firstName = "Chaitanya" + TestUtils.getRandomValue();
    static String lastName = "Mehta" + TestUtils.getRandomValue();
    static String email = "chaitanya" + TestUtils.getRandomValue() + "@gmail.com";
    static String programme = "API";
    ...
    public void test001() {
        ...
        courses.add("Acting");
        courses.add("Videography");
        courses.add("screenplay");
